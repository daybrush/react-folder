...
export interface FileManagerProps<T extends {}> {
    ...
    nameProperty?: (keyof T & string) | ((value: T, index: any, scope: any[]) => any);
    idProperty?: (keyof T & string) | ((value: T, index: any, scope: any[]) => string);
    childrenProperty?: (keyof T & string) | ((value: T, scope: any[]) => any);
    pathProperty?: (keyof T & string) | ((id: string, scope: any[], value: T, index: any) => string);
}
